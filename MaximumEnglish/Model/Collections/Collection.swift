...
class Collection:Object {
    ...
    @objc dynamic private var privateID:String = ""
    ...
    func addNewCard(ofType type:CardType, question:String, answer:String) {
        
        guard let card = DataManager.NewCard(ofType: type, question: question, answer: answer) else { return }
